	...
	else
	{
		...
		{			
			...
			$message = "					
						Hello $uname,
						<br /><br />
						Welcome to NYAA.si<br/>
						To complete your registration  please , just click following link<br/>
						<br /><br />
						<a href='http://localhost/nyaa/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
						<br /><br />
						Thanks,";
...
<meta property="og:title" content="Register to :: <?php echo $_SERVER['SERVER_NAME'];?>">
<meta property="og:image" content="../static/img/avatar/default.png">
<meta property="og:description" content="Register to <?php echo $_SERVER['SERVER_NAME'];?>">
...
<h1>Register</h1>
<form method="POST">
<input id="csrf_token" name="csrf_token" type="hidden" value="ImM1NDQ2YTVjYjI1ZDNmNWU2NmEwNmJhZGQ5ZWRmNzdmNmMzYzQ0Njci.DBsm-g.Uea7TAI-pZ1RsQCxmc5h44Ys66E">
<div class="row">
<div class="form-group col-md-4">
<div class="form-group">
<label class="control-label" for="txtuname">Username</label>
<input class="form-control" id="txtuname" name="txtuname" placeholder="Username" title="" type="text" value="">
</div>
</div>
</div>
<div class="row">
...
<input class="form-control" id="txtemail" name="txtemail" placeholder="Email address" title="" type="text" value="">
</div>
</div>
</div>
<div class="row">
...
<input class="form-control" id="txtpass" name="txtpass" placeholder="Password" title="" type="password" value="">
</div>
</div>
</div>
<div class="row">
...
<input class="form-control" id="password_confirm" name="password_confirm" placeholder="Password (confirm)" title="" type="password" value="">
</div>
</div>
</div>
<div class="row">
